...
`![air temp](/DataRockMyWorld/assets/Galaxy_5pm_GMT.png)`
...
`![Galaxy_5pm_global_temp]`(/DataRockMyWorld/assets/Galaxy_5pm_global.png)`


`![Global_air temp]`(/DataRockMyWorld.github/assets/Galaxy109-[plot_airtemp_global_montage].png)`
